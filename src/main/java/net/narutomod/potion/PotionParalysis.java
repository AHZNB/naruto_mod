...
import net.narutomod.procedure.ProcedureParalysisPotionExpires;
import net.narutomod.procedure.ProcedureParalysisOnPotionActiveTick;
...
public class PotionParalysis extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:paralysis")
	public static final Potion potion = null;
	public PotionParalysis(ElementsNarutomodMod instance) {
		super(instance, 383);
	}
	...
	public static class PotionCustom extends Potion {
		...
		public PotionCustom() {
			...
			setPotionName("effect.paralysis");
