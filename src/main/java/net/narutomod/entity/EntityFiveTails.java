...
public class EntityFiveTails extends ElementsNarutomodMod.ModElement {
		...
		public void toggleBijuCloak() {
			...
			if (this.getCloakLevel() > 0) {
				...
				if (jinchuriki.inventory.armorInventory.get(2).getItem() != ItemBijuCloak.body) {
					ProcedureUtils.swapItemToSlot(jinchuriki, EntityEquipmentSlot.CHEST, new ItemStack(ItemBijuCloak.body, 1, 5));
				}
	...
	public class ModelFiveTails extends ModelQuadruped {
		...
		public ModelFiveTails() {
			...
			cube_r1.setRotationPoint(0.0F, 1.0272F, -8.158F);
			head.addChild(cube_r1);
			setRotationAngle(cube_r1, -0.5236F, 0.0F, 0.0F);
			cube_r1.cubeList.add(new ModelBox(cube_r1, 32, 0, -2.0F, -1.3F, -0.9F, 4, 2, 2, -0.4F, false));
			cube_r2 = new ModelRenderer(this);
			cube_r2.setRotationPoint(0.0F, 0.1F, -7.5F);
			head.addChild(cube_r2);
			setRotationAngle(cube_r2, 0.2618F, 0.0F, 0.0F);
			cube_r2.cubeList.add(new ModelBox(cube_r2, 28, 8, -2.0F, -0.4F, -0.7F, 4, 2, 3, -0.1F, false));
			cube_r3 = new ModelRenderer(this);
			cube_r3.setRotationPoint(0.0F, 0.3861F, 0.5902F);
			head.addChild(cube_r3);
			setRotationAngle(cube_r3, 0.2182F, 0.0F, 0.0F);
			cube_r3.cubeList.add(new ModelBox(cube_r3, 0, 26, -2.0F, -2.5658F, -6.2052F, 4, 4, 4, 0.0F, false));
			...
			cube_r4.cubeList.add(new ModelBox(cube_r4, 20, 37, -0.5F, -1.0F, 0.0F, 1, 2, 1, -0.2F, false));
			cube_r5 = new ModelRenderer(this);
			cube_r5.setRotationPoint(0.0F, -2.517F, 0.8706F);
			bone.addChild(cube_r5);
			setRotationAngle(cube_r5, -0.3491F, 0.0F, 0.0F);
			cube_r5.cubeList.add(new ModelBox(cube_r5, 40, 13, -0.5F, -0.5F, -0.1F, 1, 2, 1, -0.1F, false));
			cube_r6 = new ModelRenderer(this);
			cube_r6.setRotationPoint(0.0F, -0.6818F, 0.3788F);
			bone.addChild(cube_r6);
			setRotationAngle(cube_r6, -0.2618F, 0.0F, 0.0F);
			cube_r6.cubeList.add(new ModelBox(cube_r6, 19, 17, -0.5F, -1.2F, -0.2F, 1, 1, 1, 0.0F, false));
			cube_r6.cubeList.add(new ModelBox(cube_r6, 16, 26, -0.5F, -0.2F, -0.2F, 1, 1, 1, 0.1F, false));
			bone4 = new ModelRenderer(this);
			bone4.setRotationPoint(-1.2F, -1.1182F, -3.1288F);
			head.addChild(bone4);
			setRotationAngle(bone4, -0.2182F, 0.0F, -0.3491F);
			cube_r7 = new ModelRenderer(this);
			cube_r7.setRotationPoint(0.0F, -3.0F, 1.5F);
			bone4.addChild(cube_r7);
			setRotationAngle(cube_r7, -0.4363F, 0.0F, 0.0F);
			cube_r7.cubeList.add(new ModelBox(cube_r7, 20, 37, -0.5F, -1.5F, 0.0F, 1, 2, 1, -0.2F, false));
			cube_r8 = new ModelRenderer(this);
			cube_r8.setRotationPoint(0.0F, -2.517F, 1.3706F);
			bone4.addChild(cube_r8);
			setRotationAngle(cube_r8, -0.3491F, 0.0F, 0.0F);
			cube_r8.cubeList.add(new ModelBox(cube_r8, 40, 13, -0.5F, -1.0F, -0.1F, 1, 2, 1, -0.1F, false));
			cube_r9 = new ModelRenderer(this);
			cube_r9.setRotationPoint(0.0F, -0.6818F, 0.8788F);
			...
			cube_r10.cubeList.add(new ModelBox(cube_r10, 20, 37, -0.5F, -1.5F, 0.0F, 1, 2, 1, -0.2F, true));
			cube_r11 = new ModelRenderer(this);
			cube_r11.setRotationPoint(0.0F, -2.517F, 1.3706F);
			bone5.addChild(cube_r11);
			setRotationAngle(cube_r11, -0.3491F, 0.0F, 0.0F);
			cube_r11.cubeList.add(new ModelBox(cube_r11, 40, 13, -0.5F, -1.0F, -0.1F, 1, 2, 1, -0.1F, true));
			cube_r12 = new ModelRenderer(this);
			cube_r12.setRotationPoint(0.0F, -0.6818F, 0.8788F);
			bone5.addChild(cube_r12);
			setRotationAngle(cube_r12, -0.2618F, 0.0F, 0.0F);
			cube_r12.cubeList.add(new ModelBox(cube_r12, 19, 17, -0.5F, -1.2F, -0.2F, 1, 1, 1, 0.0F, true));
			cube_r12.cubeList.add(new ModelBox(cube_r12, 16, 26, -0.5F, -0.2F, -0.2F, 1, 1, 1, 0.1F, true));
			bone3 = new ModelRenderer(this);
			bone3.setRotationPoint(1.2F, -0.7182F, -5.8788F);
			head.addChild(bone3);
			setRotationAngle(bone3, -0.1745F, 0.0F, 0.4363F);
			cube_r13 = new ModelRenderer(this);
			cube_r13.setRotationPoint(0.0F, -3.1736F, 2.9848F);
			bone3.addChild(cube_r13);
			setRotationAngle(cube_r13, -0.4363F, 0.0F, 0.0F);
			cube_r13.cubeList.add(new ModelBox(cube_r13, 20, 37, -0.5F, -1.0F, -1.0F, 1, 2, 1, -0.2F, true));
			cube_r14 = new ModelRenderer(this);
			cube_r14.setRotationPoint(0.0F, -2.6907F, 2.8554F);
			bone3.addChild(cube_r14);
			setRotationAngle(cube_r14, -0.3491F, 0.0F, 0.0F);
			cube_r14.cubeList.add(new ModelBox(cube_r14, 40, 13, -0.5F, -0.5F, -1.1F, 1, 2, 1, -0.1F, true));
			cube_r15 = new ModelRenderer(this);
			cube_r15.setRotationPoint(0.0F, -0.8554F, 2.3636F);
			bone3.addChild(cube_r15);
			setRotationAngle(cube_r15, -0.2618F, 0.0F, 0.0F);
			cube_r15.cubeList.add(new ModelBox(cube_r15, 19, 17, -0.5F, -1.2F, -1.2F, 1, 1, 1, 0.0F, true));
			cube_r15.cubeList.add(new ModelBox(cube_r15, 16, 26, -0.5F, -0.2F, -1.2F, 1, 2, 1, 0.1F, true));
			...
			cube_r16.setRotationPoint(-1.6901F, -0.4605F, -4.5436F);
			Jaw.addChild(cube_r16);
			setRotationAngle(cube_r16, 0.0F, -0.2182F, 0.0F);
			cube_r16.cubeList.add(new ModelBox(cube_r16, 36, 19, -0.2F, -1.0F, -1.5F, 1, 2, 3, 0.0F, false));
			cube_r17 = new ModelRenderer(this);
			cube_r17.setRotationPoint(1.7099F, -0.4605F, -4.5436F);
			Jaw.addChild(cube_r17);
			setRotationAngle(cube_r17, 0.0F, 0.2182F, 0.0F);
			cube_r17.cubeList.add(new ModelBox(cube_r17, 37, 25, -0.8F, -1.0F, -1.5F, 1, 2, 3, 0.0F, true));
			...
			Eyes.setRotationPoint(0.0F, 13.0F, -4.0F);
			RightEye = new ModelRenderer(this);
			RightEye.setRotationPoint(0.0F, 0.0F, 0.0F);
			Eyes.addChild(RightEye);
			cube_r18 = new ModelRenderer(this);
			cube_r18.setRotationPoint(-1.9099F, 0.5605F, -6.9564F);
			RightEye.addChild(cube_r18);
			setRotationAngle(cube_r18, 0.2618F, -0.1745F, -0.0436F);
			cube_r18.cubeList.add(new ModelBox(cube_r18, 19, 13, -0.4F, -1.0F, -0.5F, 1, 2, 2, -0.4F, false));
			cube_r19 = new ModelRenderer(this);
			cube_r19.setRotationPoint(-2.0F, 0.3521F, -5.7954F);
			RightEye.addChild(cube_r19);
			setRotationAngle(cube_r19, 0.2618F, 0.0F, 0.0F);
			cube_r19.cubeList.add(new ModelBox(cube_r19, 0, 13, -0.5F, -1.1F, -0.5F, 1, 2, 2, -0.4F, false));
			LeftEye = new ModelRenderer(this);
			LeftEye.setRotationPoint(0.0F, 0.0F, 0.0F);
			Eyes.addChild(LeftEye);
			cube_r20 = new ModelRenderer(this);
			cube_r20.setRotationPoint(2.0F, 0.3521F, -5.7954F);
			LeftEye.addChild(cube_r20);
			setRotationAngle(cube_r20, 0.2618F, 0.0F, 0.0F);
			cube_r20.cubeList.add(new ModelBox(cube_r20, 0, 13, -0.5F, -1.1F, -0.5F, 1, 2, 2, -0.4F, true));
			cube_r21 = new ModelRenderer(this);
			cube_r21.setRotationPoint(1.9099F, 0.5605F, -6.9564F);
			LeftEye.addChild(cube_r21);
			setRotationAngle(cube_r21, 0.2618F, 0.1745F, 0.0436F);
			cube_r21.cubeList.add(new ModelBox(cube_r21, 19, 13, -0.6F, -1.0F, -0.5F, 1, 2, 2, -0.4F, true));

			body = new ModelRenderer(this);
			body.setRotationPoint(0.0F, 13.0F, 0.0F);
			body.cubeList.add(new ModelBox(body, 0, 13, -3.0F, -2.1F, -3.4F, 6, 6, 7, -0.1F, false));
			cube_r22 = new ModelRenderer(this);
			cube_r22.setRotationPoint(0.0F, 1.2393F, 8.4817F);
			body.addChild(cube_r22);
			setRotationAngle(cube_r22, -0.1745F, 0.0F, 0.0F);
			cube_r22.cubeList.add(new ModelBox(cube_r22, 0, 0, -3.0F, -2.6F, -6.0F, 6, 5, 8, -0.3F, false));
			cube_r23 = new ModelRenderer(this);
			cube_r23.setRotationPoint(0.0F, 3.2643F, 2.7833F);
			body.addChild(cube_r23);
			setRotationAngle(cube_r23, 0.1309F, 0.0F, 0.0F);
			cube_r23.cubeList.add(new ModelBox(cube_r23, 22, 22, -2.5F, -1.4F, 0.6F, 5, 2, 4, 0.0F, false));
			...
			cube_r24.setRotationPoint(-2.0F, 6.6F, 1.0F);
			leg1.addChild(cube_r24);
			setRotationAngle(cube_r24, -0.3491F, 0.0F, 0.0F);
			cube_r24.cubeList.add(new ModelBox(cube_r24, 0, 0, -0.6F, -1.6F, -2.0F, 2, 5, 2, -0.1F, false));
			cube_r25 = new ModelRenderer(this);
			cube_r25.setRotationPoint(-1.3722F, 3.9631F, -1.0951F);
			leg1.addChild(cube_r25);
			setRotationAngle(cube_r25, 0.3054F, 0.0F, 0.1309F);
			cube_r25.cubeList.add(new ModelBox(cube_r25, 0, 34, -1.0F, -2.0F, -0.9F, 2, 4, 3, 0.0F, false));
			cube_r26 = new ModelRenderer(this);
			cube_r26.setRotationPoint(-0.3946F, -0.5729F, 0.0539F);
			leg1.addChild(cube_r26);
			setRotationAngle(cube_r26, -0.3927F, 0.0F, 0.1745F);
			cube_r26.cubeList.add(new ModelBox(cube_r26, 16, 28, -1.2F, -2.3F, -1.5F, 3, 6, 3, 0.1F, false));
			...
			cube_r27.setRotationPoint(2.0F, 6.6F, 1.0F);
			leg2.addChild(cube_r27);
			setRotationAngle(cube_r27, -0.3491F, 0.0F, -0.0349F);
			cube_r27.cubeList.add(new ModelBox(cube_r27, 0, 0, -1.35F, -1.5361F, -2.3407F, 2, 5, 2, -0.1F, true));
			cube_r28 = new ModelRenderer(this);
			cube_r28.setRotationPoint(1.3722F, 3.9631F, -1.0951F);
			leg2.addChild(cube_r28);
			setRotationAngle(cube_r28, 0.3054F, 0.0F, -0.1309F);
			cube_r28.cubeList.add(new ModelBox(cube_r28, 0, 34, -1.0F, -2.0F, -0.9F, 2, 4, 3, 0.0F, true));
			cube_r29 = new ModelRenderer(this);
			cube_r29.setRotationPoint(0.3946F, -0.5729F, 0.0539F);
			leg2.addChild(cube_r29);
			setRotationAngle(cube_r29, -0.3927F, 0.0F, -0.1745F);
			cube_r29.cubeList.add(new ModelBox(cube_r29, 16, 28, -1.8F, -2.3F, -1.5F, 3, 6, 3, 0.1F, true));
			...
			cube_r30.setRotationPoint(-0.5989F, 6.5567F, 0.2F);
			leg3.addChild(cube_r30);
			setRotationAngle(cube_r30, -0.3054F, 0.0F, 0.0F);
			cube_r30.cubeList.add(new ModelBox(cube_r30, 10, 35, -0.5F, -2.4F, -1.0F, 2, 3, 2, -0.1F, false));
			cube_r31 = new ModelRenderer(this);
			cube_r31.setRotationPoint(-0.0989F, 3.8567F, -0.1F);
			leg3.addChild(cube_r31);
			setRotationAngle(cube_r31, 0.1745F, 0.0F, 0.0F);
			cube_r31.cubeList.add(new ModelBox(cube_r31, 31, 13, -1.5F, -1.8F, -1.2F, 3, 3, 3, -0.1F, false));
			cube_r32 = new ModelRenderer(this);
			cube_r32.setRotationPoint(0.7011F, -0.9433F, 0.4F);
			leg3.addChild(cube_r32);
			setRotationAngle(cube_r32, -0.2618F, 0.0F, 0.0F);
			cube_r32.cubeList.add(new ModelBox(cube_r32, 28, 28, -2.3F, -1.4F, -1.0F, 3, 5, 3, 0.3F, false));
			...
			cube_r33.setRotationPoint(0.5989F, 6.5567F, 0.2F);
			leg4.addChild(cube_r33);
			setRotationAngle(cube_r33, -0.3054F, 0.0F, 0.0F);
			cube_r33.cubeList.add(new ModelBox(cube_r33, 10, 35, -1.5F, -2.3F, -1.2F, 2, 3, 2, -0.1F, true));
			cube_r34 = new ModelRenderer(this);
			cube_r34.setRotationPoint(0.0989F, 3.8567F, -0.1F);
			leg4.addChild(cube_r34);
			setRotationAngle(cube_r34, 0.1745F, 0.0F, 0.0F);
			cube_r34.cubeList.add(new ModelBox(cube_r34, 31, 13, -1.5F, -1.8F, -1.2F, 3, 3, 3, -0.1F, true));
			cube_r35 = new ModelRenderer(this);
			cube_r35.setRotationPoint(-0.7011F, -0.9433F, 0.4F);
			leg4.addChild(cube_r35);
			setRotationAngle(cube_r35, -0.2618F, 0.0F, 0.0F);
			cube_r35.cubeList.add(new ModelBox(cube_r35, 28, 28, -0.7F, -1.4F, -1.0F, 3, 5, 3, 0.3F, true));
