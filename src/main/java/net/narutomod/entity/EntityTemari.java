...
public class EntityTemari extends ElementsNarutomodMod.ModElement {
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelTemari(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("narutomod:textures/temari.png");
				}
			};
		});
	}
	...
	public static class ModelTemari extends ModelBase {
		...
		public ModelTemari() {
			...
			bipedHeadwear.cubeList.add(new ModelBox(bipedHeadwear, 32, 0, -4.0F, -32.0F, -4.0F, 8, 8, 8, 0.2F, false));
			bipedHeadwear.cubeList.add(new ModelBox(bipedHeadwear, 32, 0, -4.0F, -32.0F, -4.0F, 8, 8, 8, 0.4F, false));
			bipedHeadwear.cubeList.add(new ModelBox(bipedHeadwear, 32, 0, -4.0F, -32.0F, -4.0F, 8, 8, 8, 0.6F, false));
