...
public class EntityFourTails extends ElementsNarutomodMod.ModElement {
	...
	public class ModelFourTails extends ModelBiped {
		...
		public ModelFourTails() {
			...
			bipedHead.setRotationPoint(0.0F, 13.0F, -3.0F);
			...
			bipedHead.cubeList.add(new ModelBox(bipedHead, 48, 46, -0.9F, -1.3F, -2.5F, 2, 1, 1, 0.0F, false));
			...
			bipedBody.setRotationPoint(0.0F, 13.0F, 0.0F);
			bipedBody.cubeList.add(new ModelBox(bipedBody, 0, 28, -2.5F, 0.0F, -2.0F, 5, 3, 4, 0.0F, false));
			bipedBody.cubeList.add(new ModelBox(bipedBody, 22, 11, -2.5F, 3.0F, -1.5F, 5, 1, 4, 0.0F, false));
			bipedBody.cubeList.add(new ModelBox(bipedBody, 38, 20, -2.5F, 4.0F, -0.6F, 5, 1, 3, 0.0F, false));
			bipedBody.cubeList.add(new ModelBox(bipedBody, 36, 8, -2.5F, 5.0F, 0.4F, 5, 1, 3, 0.0F, false));
			//bipedBody.cubeList.add(new ModelBox(bipedBody, 44, 14, -2.5F, 0.0F, -3.0F, 5, 1, 1, 0.0F, false));
			bipedBody.cubeList.add(new ModelBox(bipedBody, 44, 12, -2.5F, 1.0F, -2.6F, 5, 1, 1, 0.0F, false));
			bipedBody.cubeList.add(new ModelBox(bipedBody, 0, 9, -5.05F, -3.3F, -1.2F, 5, 5, 6, 0.0F, false));
			bipedBody.cubeList.add(new ModelBox(bipedBody, 0, 9, 0.05F, -3.3F, -1.2F, 5, 5, 6, 0.0F, true));
			bipedBody.cubeList.add(new ModelBox(bipedBody, 0, 0, -4.0F, -5.0F, -1.0F, 8, 4, 5, 0.0F, false));
			bipedBody.cubeList.add(new ModelBox(bipedBody, 18, 16, -3.0F, -2.2F, 1.8F, 6, 8, 4, 0.0F, false));
			bipedBody.cubeList.add(new ModelBox(bipedBody, 18, 1, -4.1F, 1.0F, -2.0F, 2, 2, 8, 0.0F, false));
			bipedBody.cubeList.add(new ModelBox(bipedBody, 18, 1, 2.1F, 1.0F, -2.0F, 2, 2, 8, 0.0F, true));
			bipedBody.cubeList.add(new ModelBox(bipedBody, 0, 20, -3.9F, 3.0F, -1.3F, 2, 1, 7, 0.0F, false));
			bipedBody.cubeList.add(new ModelBox(bipedBody, 0, 20, 1.9F, 3.0F, -1.3F, 2, 1, 7, 0.0F, true));
			bipedBody.cubeList.add(new ModelBox(bipedBody, 30, 0, -3.0F, -1.0F, 5.75F, 6, 7, 1, 0.0F, false));
			bipedBody.cubeList.add(new ModelBox(bipedBody, 0, 35, -3.0F, 0.0F, 6.75F, 6, 6, 1, 0.0F, false));
			bipedBody.cubeList.add(new ModelBox(bipedBody, 26, 39, -2.5F, 1.0F, 7.75F, 5, 6, 1, 0.0F, false));
			...
			pec6_r1.cubeList.add(new ModelBox(pec6_r1, 49, 8, -1.5F, 3.5699F, -0.5414F, 2, 2, 1, -0.1F, true));
			pec6_r1.cubeList.add(new ModelBox(pec6_r1, 49, 8, -3.5F, 3.5699F, -0.5414F, 2, 2, 1, -0.1F, false));
			pec6_r1.cubeList.add(new ModelBox(pec6_r1, 47, 35, -1.6F, 1.5699F, -0.7914F, 3, 2, 1, -0.2F, true));
			pec6_r1.cubeList.add(new ModelBox(pec6_r1, 47, 35, -4.4F, 1.5699F, -0.7914F, 3, 2, 1, -0.2F, false));
			...
			pec2_r1.cubeList.add(new ModelBox(pec2_r1, 47, 38, -1.5F, -0.5F, -0.5F, 3, 2, 1, -0.05F, true));
			pec2_r1.cubeList.add(new ModelBox(pec2_r1, 47, 38, -4.5F, -0.5F, -0.5F, 3, 2, 1, -0.05F, false));
			bipedRightArm = new ModelRenderer(this);
			bipedRightArm.setRotationPoint(-5.25F, 12.25F, 0.5F);
			...
			bipedRightArm.cubeList.add(new ModelBox(bipedRightArm, 22, 46, -1.4F, -1.75F, -1.6F, 1, 1, 3, 0.0F, false));
			bipedRightArm.cubeList.add(new ModelBox(bipedRightArm, 22, 46, -1.4F, -1.5F, -1.6F, 1, 1, 3, 0.0F, false));
			bipedRightArm.cubeList.add(new ModelBox(bipedRightArm, 43, 45, -0.65F, -2.1F, -1.6F, 1, 2, 3, 0.0F, false));
			bipedRightArm.cubeList.add(new ModelBox(bipedRightArm, 14, 28, -2.15F, -1.2F, -1.6F, 1, 1, 3, 0.0F, false));
			...
			bipedLeftArm.setRotationPoint(5.25F, 12.25F, 0.5F);
			...
			bipedLeftArm.cubeList.add(new ModelBox(bipedLeftArm, 22, 46, 0.4F, -1.75F, -1.6F, 1, 1, 3, 0.0F, true));
			bipedLeftArm.cubeList.add(new ModelBox(bipedLeftArm, 22, 46, 0.4F, -1.5F, -1.6F, 1, 1, 3, 0.0F, true));
			bipedLeftArm.cubeList.add(new ModelBox(bipedLeftArm, 43, 45, -0.35F, -2.1F, -1.6F, 1, 2, 3, 0.0F, true));
			bipedLeftArm.cubeList.add(new ModelBox(bipedLeftArm, 14, 28, 1.15F, -1.2F, -1.6F, 1, 1, 3, 0.0F, true));
			...
			bipedRightLeg.setRotationPoint(-1.5F, 19.5F, 6.75F);
			...
			bipedLeftLeg.setRotationPoint(1.5F, 19.5F, 6.75F);
			...
			Tail[0][0].setRotationPoint(1.5F, 17.5F, 9.0F);
			...
			Tail[1][0].setRotationPoint(0.5F, 17.5F, 9.0F);
			...
			Tail[2][0].setRotationPoint(-0.5F, 17.5F, 9.0F);
			...
			Tail[3][0].setRotationPoint(-1.5F, 17.5F, 9.0F);
		...
		public void setRotationAngles(float f0, float f1, float f2, float f3, float f4, float f5, Entity e) {
			...
			bipedHeadwear.rotationPointY += 13.0F;
			bipedRightArm.rotationPointZ += 0.5F;
			bipedRightArm.rotationPointX += -0.25F;
			bipedLeftArm.rotationPointZ += 0.5F;
			bipedLeftArm.rotationPointX += 0.25F;
			bipedRightLeg.rotationPointY += 7.5F;
			bipedRightLeg.rotationPointZ += 6.65F;
			bipedLeftLeg.rotationPointY += 7.5F;
			bipedLeftLeg.rotationPointZ += 6.65F;
			for (int i = 0; i < 4; i++) {
				for (int j = 1; j < 6; j++) {
					if (j <= 3) {
