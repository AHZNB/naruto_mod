...
public class EntityThreeTails extends ElementsNarutomodMod.ModElement {
		...
		public void toggleBijuCloak() {
			...
			if (this.getCloakLevel() > 0) {
				...
				if (jinchuriki.inventory.armorInventory.get(2).getItem() != ItemBijuCloak.body) {
					ProcedureUtils.swapItemToSlot(jinchuriki, EntityEquipmentSlot.CHEST, new ItemStack(ItemBijuCloak.body, 1, 3));
				}
	...
	public class ModelThreeTails extends ModelBiped {
		...
		public ModelThreeTails() {
			...
			bipedHeadwear.cubeList.add(new ModelBox(bipedHeadwear, 17, 52, 0.6F, -1.2F, -5.0F, 1, 1, 1, 0.1F, false));
			...
			bone83.cubeList.add(new ModelBox(bone83, 0, 0, -3.5F, -3.0F, -3.0F, 7, 5, 7, 0.0F, false));
			bone83.cubeList.add(new ModelBox(bone83, 20, 31, -3.5F, 1.0F, 6.0F, 7, 3, 2, 0.0F, false));
			bone83.cubeList.add(new ModelBox(bone83, 21, 12, -4.5F, 0.0F, 5.0F, 1, 3, 1, 0.0F, false));
			bone83.cubeList.add(new ModelBox(bone83, 21, 12, 3.5F, 0.0F, 5.0F, 1, 3, 1, 0.0F, true));
			bone83.cubeList.add(new ModelBox(bone83, 3, 4, -4.5F, 1.0F, 6.0F, 1, 2, 1, 0.0F, false));
			bone83.cubeList.add(new ModelBox(bone83, 3, 4, 3.5F, 1.0F, 6.0F, 1, 2, 1, 0.0F, true));
			bone83.cubeList.add(new ModelBox(bone83, 0, 0, -4.5F, -1.0F, 4.0F, 1, 4, 1, 0.0F, false));
			bone83.cubeList.add(new ModelBox(bone83, 0, 0, 3.5F, -1.0F, 4.0F, 1, 4, 1, 0.0F, true));
			bone83.cubeList.add(new ModelBox(bone83, 27, 36, -3.5F, 0.0F, 5.0F, 7, 4, 1, 0.0F, false));
			bone83.cubeList.add(new ModelBox(bone83, 32, 17, -3.5F, -1.0F, 4.0F, 7, 5, 1, 0.0F, false));
			bone83.cubeList.add(new ModelBox(bone83, 0, 12, -3.6F, 1.2593F, -3.0789F, 7, 3, 7, 0.0F, false));
			bone83.cubeList.add(new ModelBox(bone83, 21, 20, -5.5F, -2.0F, -2.7F, 2, 4, 7, 0.0F, false));
			bone83.cubeList.add(new ModelBox(bone83, 21, 20, 3.5F, -2.0F, -2.7F, 2, 4, 7, 0.0F, true));
			cube_r6 = new ModelRenderer(this);
			cube_r6.setRotationPoint(3.0F, 2.7211F, -0.1882F);
			bone83.addChild(cube_r6);
			...
			Shell.setRotationPoint(-0.1F, -2.25F, 2.5F);
			...
			bipedRightArm.setRotationPoint(-5.5F, 16.0F, 0.5F);
			...
			bipedLeftArm.setRotationPoint(5.5F, 16.0F, 0.5F);
			cube_r30 = new ModelRenderer(this);
			cube_r30.setRotationPoint(2.4F, 4.4526F, -2.95F);
			bipedLeftArm.addChild(cube_r30);
			setRotationAngle(cube_r30, -0.48F, 0.0873F, 0.0F);
			cube_r30.cubeList.add(new ModelBox(cube_r30, 0, 36, -1.7F, -2.5F, -1.1F, 3, 5, 3, 0.0F, true));
			cube_r31 = new ModelRenderer(this);
			cube_r31.setRotationPoint(2.0F, 1.0F, -1.0F);
			bipedLeftArm.addChild(cube_r31);
			setRotationAngle(cube_r31, -0.48F, 0.0F, -0.5236F);
			cube_r31.cubeList.add(new ModelBox(cube_r31, 40, 38, -1.5F, -2.0F, -1.5F, 3, 4, 3, 0.0F, true));
		...
		public void setRotationAngles(float f0, float f1, float f2, float f3, float f4, float f5, Entity e) {
			...
			if (((EntityCustom)e).isShooting()) {
				...
				bipedHeadwear.rotateAngleX += -0.1745F;
