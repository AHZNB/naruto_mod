	...
	public static class Renderer extends EntityRendererRegister {
		...
		public class ModelBiped64 extends EntityNinjaMob.ModelNinja {
			...
			public ModelBiped64() {
				...
				hair.addChild(bone7);
				setRotationAngle(bone7, -0.1309F, 0.0F, 0.1309F);
				...
				hair.addChild(bone8);
				setRotationAngle(bone8, 0.1309F, 0.0F, 0.1309F);
