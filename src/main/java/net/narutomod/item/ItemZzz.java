...
public class ItemZzz extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:zzz")
	public static final Item block = null;
	public ItemZzz(ElementsNarutomodMod instance) {
		super(instance, 713);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("narutomod:zzz", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 1;
			setUnlocalizedName("zzz");
			setRegistryName("zzz");
			setCreativeTab(null);
		}
