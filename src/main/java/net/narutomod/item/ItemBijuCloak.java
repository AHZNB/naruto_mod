...
public class ItemBijuCloak extends ElementsNarutomodMod.ModElement {
								...
								if (getCloakLevel(itemstack) != cloakLevel) {
				 				...
				 				int cloakXp = EntityBijuManager.getCloakXp(livingEntity);
						 	 	...
						 	 	if (wearingTicks <= cloakXp * 5 + 200 && net.narutomod.Chakra.pathway(livingEntity).getAmount() > 0d) {
									...
									if (entity.ticksExisted % 30 == 0 && cloakLevel == 1 && tails != 1) {
	...
	public class ModelBijuCloak extends ModelBiped {
		...
		private final ModelRenderer sandBodyL2;
		...
		private final ModelRenderer sandArmRight;
		private final ModelRenderer bipedLeftArmWear;
		private final ModelRenderer sandArmLeft;
		...
		public ModelBijuCloak(int tails) {
			...
			setRotationAngle(sandEar, -0.7782F, -0.0998F, -0.4052F);
			sandEar.cubeList.add(new ModelBox(sandEar, 118, 0, -1.0F, -2.8F, -2.0F, 2, 6, 3, 0.0F, false));
			sandHeadL2 = new ModelRenderer(this);
			sandHeadL2.setRotationPoint(0.0F, 0.0F, 0.0F);
			bipedHeadwear.addChild(sandHeadL2);
			sandHeadL2.cubeList.add(new ModelBox(sandHeadL2, 64, 0, -4.0F, -8.0F, -4.0F, 8, 8, 8, 0.65F, true));
			...
			setRotationAngle(sandEar2, -0.7782F, 0.0998F, 0.4052F);
			sandEar2.cubeList.add(new ModelBox(sandEar2, 118, 0, -1.0F, -2.8F, -2.0F, 2, 6, 3, 0.0F, true));
			...
			sandBodyL2 = new ModelRenderer(this);
			sandBodyL2.setRotationPoint(0.0F, 24.0F, 0.0F);
			bipedBodyWear.addChild(sandBodyL2);
			sandBodyL2.cubeList.add(new ModelBox(sandBodyL2, 80, 32, -4.0F, -24.0F, -2.0F, 8, 12, 4, 0.7F, true));
			...
			tailWear[0][0].cubeList.add(new ModelBox(tailWear[0][0], 102, 4, -2.0F, -5.5F, -2.0F, 4, 6, 4, tails == 1 ? 1.5F : 0.01F, false));
			...
			tailWear[0][1].cubeList.add(new ModelBox(tailWear[0][1], 102, 4, -2.0F, -5.5F, -2.0F, 4, 6, 4, tails == 1 ? 1.1F : 0.31F, false));
			...
			sandArmRight = new ModelRenderer(this);
			sandArmLeft = new ModelRenderer(this);
			if (tails == 1) {
				sandArmRight.setRotationPoint(-1.6421F, 7.959F, -3.46F);
				bipedRightArmWear.addChild(sandArmRight);
				ModelRenderer bump2 = new ModelRenderer(this);
				bump2.setRotationPoint(0.4421F, -2.584F, 3.21F);
				sandArmRight.addChild(bump2);
				ModelRenderer cube_r1 = new ModelRenderer(this);
				cube_r1.setRotationPoint(0.0F, 0.0F, 0.2F);
				bump2.addChild(cube_r1);
				setRotationAngle(cube_r1, -0.4102F, -0.4102F, -0.7854F);
				cube_r1.cubeList.add(new ModelBox(cube_r1, 88, 0, -2.0F, -2.0F, -2.0F, 4, 4, 4, 0.6F, false));
				ModelRenderer bump = new ModelRenderer(this);
				bump.setRotationPoint(0.4421F, -8.584F, 3.21F);
				sandArmRight.addChild(bump);
				setRotationAngle(bump, 0.0F, 0.0F, 0.48F);
				ModelRenderer cube_r2 = new ModelRenderer(this);
				cube_r2.setRotationPoint(0.0F, 0.0F, 0.0F);
				bump.addChild(cube_r2);
				setRotationAngle(cube_r2, -0.4102F, -0.4102F, -0.7854F);
				cube_r2.cubeList.add(new ModelBox(cube_r2, 88, 0, -1.9203F, -2.0731F, -1.8318F, 4, 4, 4, 0.6F, false));
				ModelRenderer sandForeArm = new ModelRenderer(this);
				sandForeArm.setRotationPoint(0.6421F, 2.041F, 5.96F);
				sandArmRight.addChild(sandForeArm);
				setRotationAngle(sandForeArm, -0.2618F, 0.0F, 0.0F);
				sandForeArm.cubeList.add(new ModelBox(sandForeArm, 104, 32, -2.0F, 1.0F, -4.5F, 4, 6, 4, 0.8F, false));
				ModelRenderer sandHand = new ModelRenderer(this);
				sandHand.setRotationPoint(-3.0F, 9.0F, -4.5F);
				sandForeArm.addChild(sandHand);
				ModelRenderer finger = new ModelRenderer(this);
				finger.setRotationPoint(1.425F, -2.5F, 0.5F);
				sandHand.addChild(finger);
				setRotationAngle(finger, -0.3491F, 0.3491F, 0.2618F);
				finger.cubeList.add(new ModelBox(finger, 120, 35, -1.0F, 0.0F, -1.0F, 2, 4, 2, 0.0F, false));
				ModelRenderer finger7 = new ModelRenderer(this);
				finger7.setRotationPoint(-1.0F, 4.0F, -1.0F);
				finger.addChild(finger7);
				setRotationAngle(finger7, 0.5236F, 0.1309F, -0.5236F);
				finger7.cubeList.add(new ModelBox(finger7, 120, 42, -0.25F, -0.25F, -0.25F, 2, 4, 2, -0.25F, false));
				ModelRenderer finger2 = new ModelRenderer(this);
				finger2.setRotationPoint(1.425F, -2.5F, 3.75F);
				sandHand.addChild(finger2);
				setRotationAngle(finger2, 0.7646F, 1.0953F, 1.1011F);
				finger2.cubeList.add(new ModelBox(finger2, 120, 35, -1.0F, 0.0F, -1.0F, 2, 4, 2, 0.0F, false));
				ModelRenderer finger8 = new ModelRenderer(this);
				finger8.setRotationPoint(-1.0F, 4.0F, -1.0F);
				finger2.addChild(finger8);
				setRotationAngle(finger8, 0.5236F, 0.1309F, -0.5236F);
				finger8.cubeList.add(new ModelBox(finger8, 120, 42, -0.25F, -0.25F, -0.25F, 2, 4, 2, -0.25F, false));
				ModelRenderer finger3 = new ModelRenderer(this);
				finger3.setRotationPoint(4.575F, -3.25F, 0.5F);
				sandHand.addChild(finger3);
				setRotationAngle(finger3, -2.7109F, -1.1565F, 2.4146F);
				finger3.cubeList.add(new ModelBox(finger3, 120, 35, -1.0F, 0.0F, -1.0F, 2, 4, 2, 0.0F, false));
				ModelRenderer finger9 = new ModelRenderer(this);
				finger9.setRotationPoint(-1.0F, 4.0F, -1.0F);
				finger3.addChild(finger9);
				setRotationAngle(finger9, 0.5236F, 0.1309F, -0.5236F);
				finger9.cubeList.add(new ModelBox(finger9, 120, 42, -0.25F, -0.25F, -0.25F, 2, 4, 2, -0.25F, false));
				ModelRenderer finger4 = new ModelRenderer(this);
				finger4.setRotationPoint(1.425F, -2.0F, 2.5F);
				sandHand.addChild(finger4);
				setRotationAngle(finger4, -0.1749F, 0.8043F, 0.3835F);
				finger4.cubeList.add(new ModelBox(finger4, 120, 35, -1.0F, 0.0F, -1.0F, 2, 4, 2, 0.0F, false));
				ModelRenderer finger5 = new ModelRenderer(this);
				finger5.setRotationPoint(-1.0F, 4.0F, -1.0F);
				finger4.addChild(finger5);
				setRotationAngle(finger5, 0.5236F, 0.1309F, -0.5236F);
				finger5.cubeList.add(new ModelBox(finger5, 120, 42, -0.25F, -0.25F, -0.25F, 2, 4, 2, -0.25F, false));
				ModelRenderer spareFingers = new ModelRenderer(this);
				spareFingers.setRotationPoint(-0.6421F, 5.959F, -5.96F);
				sandForeArm.addChild(spareFingers);
				ModelRenderer cube_r3 = new ModelRenderer(this);
				cube_r3.setRotationPoint(0.0F, 0.0F, 0.0F);
				spareFingers.addChild(cube_r3);
				setRotationAngle(cube_r3, -1.0323F, -0.9243F, 0.6527F);
				cube_r3.cubeList.add(new ModelBox(cube_r3, 120, 42, -0.25F, -2.0F, -1.0F, 2, 4, 2, -0.25F, false));
				ModelRenderer cube_r4 = new ModelRenderer(this);
				cube_r4.setRotationPoint(-1.3089F, -4.5636F, 3.7447F);
				spareFingers.addChild(cube_r4);
				setRotationAngle(cube_r4, 0.158F, 0.3333F, 0.7591F);
				cube_r4.cubeList.add(new ModelBox(cube_r4, 120, 42, -2.475F, -2.0F, -1.0F, 2, 4, 2, -0.25F, false));
				ModelRenderer cube_r5 = new ModelRenderer(this);
				cube_r5.setRotationPoint(0.5218F, 0.2381F, 6.7784F);
				spareFingers.addChild(cube_r5);
				setRotationAngle(cube_r5, 1.6292F, 0.9065F, 1.702F);
				cube_r5.cubeList.add(new ModelBox(cube_r5, 120, 42, -1.0F, -3.0F, -2.175F, 2, 4, 2, -0.25F, false));
				ModelRenderer cube_r6 = new ModelRenderer(this);
				cube_r6.setRotationPoint(2.0926F, -1.7054F, 7.3658F);
				spareFingers.addChild(cube_r6);
				setRotationAngle(cube_r6, 2.1954F, 0.765F, 2.1088F);
				cube_r6.cubeList.add(new ModelBox(cube_r6, 120, 42, -2.15F, -5.25F, -0.625F, 2, 4, 2, -0.25F, false));

				sandArmLeft.setRotationPoint(1.6421F, 7.959F, -3.46F);
				bipedLeftArmWear.addChild(sandArmLeft);
				sandArmLeft.cubeList.add(new ModelBox(sandArmLeft, 104, 32, -2.6421F, -9.959F, 1.46F, 4, 12, 4, 0.7F, true));
				ModelRenderer bump3 = new ModelRenderer(this);
				bump3.setRotationPoint(-0.4421F, -2.584F, 3.21F);
				sandArmLeft.addChild(bump3);
				ModelRenderer cube_r7 = new ModelRenderer(this);
				cube_r7.setRotationPoint(0.0F, 0.0F, 0.2F);
				bump3.addChild(cube_r7);
				setRotationAngle(cube_r7, -0.4102F, 0.4102F, 0.7854F);
				cube_r7.cubeList.add(new ModelBox(cube_r7, 88, 0, -2.0F, -2.0F, -2.0F, 4, 4, 4, 0.6F, true));
				ModelRenderer bump4 = new ModelRenderer(this);
				bump4.setRotationPoint(-0.4421F, -8.584F, 3.21F);
				sandArmLeft.addChild(bump4);
				setRotationAngle(bump4, 0.0F, 0.0F, -0.48F);
				ModelRenderer cube_r8 = new ModelRenderer(this);
				cube_r8.setRotationPoint(0.0F, 0.0F, 0.0F);
				bump4.addChild(cube_r8);
				setRotationAngle(cube_r8, -0.4102F, 0.4102F, 0.7854F);
				cube_r8.cubeList.add(new ModelBox(cube_r8, 88, 0, -2.0797F, -2.0731F, -1.8318F, 4, 4, 4, 0.6F, true));
				ModelRenderer sandForeArm2 = new ModelRenderer(this);
				sandForeArm2.setRotationPoint(-0.6421F, 2.041F, 5.96F);
				sandArmLeft.addChild(sandForeArm2);
				setRotationAngle(sandForeArm2, -0.2618F, 0.0F, 0.0F);
				sandForeArm2.cubeList.add(new ModelBox(sandForeArm2, 104, 32, -2.0F, 1.0F, -4.5F, 4, 6, 4, 0.8F, true));
				ModelRenderer sandHand2 = new ModelRenderer(this);
				sandHand2.setRotationPoint(3.0F, 9.0F, -4.5F);
				sandForeArm2.addChild(sandHand2);
				ModelRenderer finger6 = new ModelRenderer(this);
				finger6.setRotationPoint(-1.425F, -2.5F, 0.5F);
				sandHand2.addChild(finger6);
				setRotationAngle(finger6, -0.3491F, -0.3491F, -0.2618F);
				finger6.cubeList.add(new ModelBox(finger6, 120, 35, -1.0F, 0.0F, -1.0F, 2, 4, 2, 0.0F, true));
				ModelRenderer finger10 = new ModelRenderer(this);
				finger10.setRotationPoint(1.0F, 4.0F, -1.0F);
				finger6.addChild(finger10);
				setRotationAngle(finger10, 0.5236F, -0.1309F, 0.5236F);
				finger10.cubeList.add(new ModelBox(finger10, 120, 42, -1.75F, -0.25F, -0.25F, 2, 4, 2, -0.25F, true));
				ModelRenderer finger11 = new ModelRenderer(this);
				finger11.setRotationPoint(-1.425F, -2.5F, 3.75F);
				sandHand2.addChild(finger11);
				setRotationAngle(finger11, 0.7646F, -1.0953F, -1.1011F);
				finger11.cubeList.add(new ModelBox(finger11, 120, 35, -1.0F, 0.0F, -1.0F, 2, 4, 2, 0.0F, true));
				ModelRenderer finger12 = new ModelRenderer(this);
				finger12.setRotationPoint(1.0F, 4.0F, -1.0F);
				finger11.addChild(finger12);
				setRotationAngle(finger12, 0.5236F, -0.1309F, 0.5236F);
				finger12.cubeList.add(new ModelBox(finger12, 120, 42, -1.75F, -0.25F, -0.25F, 2, 4, 2, -0.25F, true));
				ModelRenderer finger13 = new ModelRenderer(this);
				finger13.setRotationPoint(-4.575F, -3.25F, 0.5F);
				sandHand2.addChild(finger13);
				setRotationAngle(finger13, -2.7109F, 1.1565F, -2.4146F);
				finger13.cubeList.add(new ModelBox(finger13, 120, 35, -1.0F, 0.0F, -1.0F, 2, 4, 2, 0.0F, true));
				ModelRenderer finger14 = new ModelRenderer(this);
				finger14.setRotationPoint(1.0F, 4.0F, -1.0F);
				finger13.addChild(finger14);
				setRotationAngle(finger14, 0.5236F, -0.1309F, 0.5236F);
				finger14.cubeList.add(new ModelBox(finger14, 120, 42, -1.75F, -0.25F, -0.25F, 2, 4, 2, -0.25F, true));
				ModelRenderer finger15 = new ModelRenderer(this);
				finger15.setRotationPoint(-1.425F, -2.0F, 2.5F);
				sandHand2.addChild(finger15);
				setRotationAngle(finger15, -0.1749F, -0.8043F, -0.3835F);
				finger15.cubeList.add(new ModelBox(finger15, 120, 35, -1.0F, 0.0F, -1.0F, 2, 4, 2, 0.0F, true));
				ModelRenderer finger16 = new ModelRenderer(this);
				finger16.setRotationPoint(1.0F, 4.0F, -1.0F);
				finger15.addChild(finger16);
				setRotationAngle(finger16, 0.5236F, -0.1309F, 0.5236F);
				finger16.cubeList.add(new ModelBox(finger16, 120, 42, -1.75F, -0.25F, -0.25F, 2, 4, 2, -0.25F, true));
				ModelRenderer spareFingers2 = new ModelRenderer(this);
				spareFingers2.setRotationPoint(0.6421F, 5.959F, -5.96F);
				sandForeArm2.addChild(spareFingers2);
				ModelRenderer cube_r9 = new ModelRenderer(this);
				cube_r9.setRotationPoint(0.0F, 0.0F, 0.0F);
				spareFingers2.addChild(cube_r9);
				setRotationAngle(cube_r9, -1.0323F, 0.9243F, -0.6527F);
				cube_r9.cubeList.add(new ModelBox(cube_r9, 120, 42, -1.75F, -2.0F, -1.0F, 2, 4, 2, -0.25F, true));
				ModelRenderer cube_r10 = new ModelRenderer(this);
				cube_r10.setRotationPoint(1.3089F, -4.5636F, 3.7447F);
				spareFingers2.addChild(cube_r10);
				setRotationAngle(cube_r10, 0.158F, -0.3333F, -0.7591F);
				cube_r10.cubeList.add(new ModelBox(cube_r10, 120, 42, 0.475F, -2.0F, -1.0F, 2, 4, 2, -0.25F, true));
				ModelRenderer cube_r11 = new ModelRenderer(this);
				cube_r11.setRotationPoint(-0.5218F, 0.2381F, 6.7784F);
				spareFingers2.addChild(cube_r11);
				setRotationAngle(cube_r11, 1.6292F, -0.9065F, -1.702F);
				cube_r11.cubeList.add(new ModelBox(cube_r11, 120, 42, -1.0F, -3.0F, -2.175F, 2, 4, 2, -0.25F, true));
				ModelRenderer cube_r12 = new ModelRenderer(this);
				cube_r12.setRotationPoint(-2.0926F, -1.7054F, 7.3658F);
				spareFingers2.addChild(cube_r12);
				setRotationAngle(cube_r12, 2.1954F, -0.765F, -2.1088F);
				cube_r12.cubeList.add(new ModelBox(cube_r12, 120, 42, 0.15F, -5.25F, -0.625F, 2, 4, 2, -0.25F, true));
			}
		...
		private void setModelVisibilities(int numberoftails) {
			...
			if (numberoftails != 1) {
				sandArmRight.showModel = false;
				sandArmLeft.showModel = false;
				sandBodyL2.showModel = false;
			} else {
