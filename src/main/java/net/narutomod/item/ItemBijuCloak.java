...
public class ItemBijuCloak extends ElementsNarutomodMod.ModElement {
	...
	public class ModelBijuCloak extends ModelBiped {
		...
		public ModelBijuCloak(int tails) {
			...
			tailWear[0][0].cubeList.add(new ModelBox(tailWear[0][0], 102, 4, -2.0F, -5.5F, -2.0F, 4, 6, 4, tails == 1 ? 1.0F : 0.01F, false));
			...
			tailWear[0][1].cubeList.add(new ModelBox(tailWear[0][1], 102, 4, -2.0F, -5.5F, -2.0F, 4, 6, 4, tails == 1 ? 0.8F : 0.31F, false));
			...
			if (tails == 1) {
				...
				cube_r2.setRotationPoint(0.0F, 0.0F, 0.2F);
				bump2.addChild(cube_r2);
				setRotationAngle(cube_r2, -0.4102F, -0.4102F, -0.7854F);
				cube_r2.cubeList.add(new ModelBox(cube_r2, 88, 0, -2.0F, -2.0F, -2.0F, 4, 4, 4, 0.6F, false));
				...
				bump.addChild(cube_r3);
				setRotationAngle(cube_r3, -0.4102F, -0.4102F, -0.7854F);
				cube_r3.cubeList.add(new ModelBox(cube_r3, 88, 0, -1.9203F, -2.0731F, -1.8318F, 4, 4, 4, 0.6F, false));
				ModelRenderer sandForeArm = new ModelRenderer(this);
				sandForeArm.setRotationPoint(0.6421F, 2.041F, 5.96F);
				sandArm.addChild(sandForeArm);
				...
				sandHand.setRotationPoint(-3.0F, 8.0F, -4.5F);
				...
				setRotationAngle(cube_r4, -0.0999F, -0.5148F, 0.2009F);
				cube_r4.cubeList.add(new ModelBox(cube_r4, 120, 35, -0.075F, -3.0F, -1.0F, 2, 4, 2, 0.0F, false));
				ModelRenderer cube_r5 = new ModelRenderer(this);
				cube_r5.setRotationPoint(1.1324F, 2.5785F, 0.6538F);
				finger.addChild(cube_r5);
				setRotationAngle(cube_r5, 0.1719F, -0.4971F, -0.3492F);
				cube_r5.cubeList.add(new ModelBox(cube_r5, 120, 42, -1.0F, -2.3F, -1.0F, 2, 4, 2, -0.25F, false));
				...
				cube_r6.setRotationPoint(0.9968F, -0.7341F, 0.5755F);
				finger3.addChild(cube_r6);
				setRotationAngle(cube_r6, 0.0999F, -0.5148F, -0.2009F);
				cube_r6.cubeList.add(new ModelBox(cube_r6, 120, 35, -1.925F, -3.0F, -1.0F, 2, 4, 2, 0.0F, true));
				ModelRenderer cube_r7 = new ModelRenderer(this);
				cube_r7.setRotationPoint(-0.1356F, 1.8444F, -0.0783F);
				finger3.addChild(cube_r7);
				setRotationAngle(cube_r7, -0.1719F, -0.4971F, 0.3492F);
				cube_r7.cubeList.add(new ModelBox(cube_r7, 120, 42, -1.0F, -2.3F, -1.0F, 2, 4, 2, -0.25F, true));
				...
				setRotationAngle(cube_r8, 0.0999F, 0.5148F, 0.2009F);
				cube_r8.cubeList.add(new ModelBox(cube_r8, 120, 35, -0.075F, -3.0F, -1.0F, 2, 4, 2, 0.0F, false));
				ModelRenderer cube_r9 = new ModelRenderer(this);
				cube_r9.setRotationPoint(1.1324F, 2.5785F, -0.6538F);
				finger2.addChild(cube_r9);
				setRotationAngle(cube_r9, -0.1719F, 0.4971F, -0.3492F);
				cube_r9.cubeList.add(new ModelBox(cube_r9, 120, 42, -1.0F, -2.3F, -1.0F, 2, 4, 2, -0.25F, false));
				...
				spareFingers.addChild(cube_r10);
				setRotationAngle(cube_r10, -1.6095F, -1.0268F, 1.3404F);
				cube_r10.cubeList.add(new ModelBox(cube_r10, 120, 42, -0.25F, -2.0F, -1.0F, 2, 4, 2, -0.25F, false));
				ModelRenderer cube_r11 = new ModelRenderer(this);
				cube_r11.setRotationPoint(-1.3089F, -4.5636F, 3.7447F);
				spareFingers.addChild(cube_r11);
				setRotationAngle(cube_r11, 0.1512F, 0.1609F, 0.7314F);
				cube_r11.cubeList.add(new ModelBox(cube_r11, 120, 42, -2.475F, -2.0F, -1.0F, 2, 4, 2, -0.25F, false));
				ModelRenderer cube_r12 = new ModelRenderer(this);
				cube_r12.setRotationPoint(0.5218F, 0.2381F, 6.7784F);
				spareFingers.addChild(cube_r12);
				setRotationAngle(cube_r12, 1.6292F, 0.9065F, 1.702F);
				cube_r12.cubeList.add(new ModelBox(cube_r12, 120, 42, -1.0F, -3.0F, -2.175F, 2, 4, 2, -0.25F, false));
				ModelRenderer cube_r13 = new ModelRenderer(this);
				cube_r13.setRotationPoint(2.5926F, -1.7054F, 6.8658F);
				spareFingers.addChild(cube_r13);
				setRotationAngle(cube_r13, 1.1536F, 0.8762F, 0.7801F);
				cube_r13.cubeList.add(new ModelBox(cube_r13, 120, 42, -2.15F, -5.25F, -0.625F, 2, 4, 2, -0.25F, false));
			}
