...
public class ItemClothesMizukage extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:clothes_mizukagehelmet")
	public static final Item helmet = null;

	public ItemClothesMizukage(ElementsNarutomodMod instance) {
		super(instance, 818);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemArmor(enuma, 0, EntityEquipmentSlot.HEAD) {
			...
			public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
				ModelBiped armorModel = new ModelRobe();
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(helmet, 0, new ModelResourceLocation("narutomod:clothes_mizukagehelmet", "inventory"));
	}
	...
	public static class ModelRobe extends ModelBiped {
		...
		public ModelRobe() {
			...
			cube_r1.setRotationPoint(0.866F, 2.5F, 3.392F);
			bone22.addChild(cube_r1);
			setRotationAngle(cube_r1, -0.6589F, 0.0F, 0.0F);
			cube_r1.cubeList.add(new ModelBox(cube_r1, -10, 16, -7.5F, -0.0361F, -9.9375F, 15, 0, 10, 0.0F, false));
			bone24 = new ModelRenderer(this);
			bone24.setRotationPoint(0.866F, -0.25F, 11.6146F);
			hhat2.addChild(bone24);
			cube_r2 = new ModelRenderer(this);
			cube_r2.setRotationPoint(-0.866F, 2.5F, -4.2037F);
			bone24.addChild(cube_r2);
			setRotationAngle(cube_r2, -0.6589F, 0.0F, 0.0F);
			cube_r2.cubeList.add(new ModelBox(cube_r2, -10, 16, -7.5F, -0.0361F, -9.9375F, 15, 0, 10, 0.0F, false));
			...
			cube_r3.setRotationPoint(-3.5459F, 3.0514F, 7.4279F);
			logo2.addChild(cube_r3);
			setRotationAngle(cube_r3, -0.6589F, 0.0F, 0.0F);
			cube_r3.cubeList.add(new ModelBox(cube_r3, 23, 16, -0.5F, -0.0361F, -8.9375F, 8, 0, 9, 0.0F, false));
			logo = new ModelRenderer(this);
			logo.setRotationPoint(0.866F, -33.15F, -4.1104F);
			logo3.addChild(logo);
			setRotationAngle(logo, 0.0F, 3.1416F, 0.0F);
			cube_r4 = new ModelRenderer(this);
			cube_r4.setRotationPoint(0.866F, 2.5F, 3.392F);
			logo.addChild(cube_r4);
			setRotationAngle(cube_r4, -0.6589F, 0.0F, 0.0F);
			cube_r4.cubeList.add(new ModelBox(cube_r4, 39, 16, -7.5F, -0.0361F, -8.9375F, 8, 0, 9, 0.0F, false));
			bone23 = new ModelRenderer(this);
			bone23.setRotationPoint(0.866F, -0.25F, -4.0354F);
			hhat.addChild(bone23);
			setRotationAngle(bone23, 0.0F, 3.1416F, 0.0F);
			cube_r5 = new ModelRenderer(this);
			cube_r5.setRotationPoint(0.866F, 2.5F, 3.392F);
			bone23.addChild(cube_r5);
			setRotationAngle(cube_r5, -0.6589F, 0.0F, 0.0F);
			cube_r5.cubeList.add(new ModelBox(cube_r5, -10, 16, -7.5F, -0.0361F, -9.9375F, 15, 0, 10, 0.0F, false));
			bone21 = new ModelRenderer(this);
			bone21.setRotationPoint(0.866F, -0.25F, 11.6146F);
			hhat.addChild(bone21);
			cube_r6 = new ModelRenderer(this);
			cube_r6.setRotationPoint(-0.866F, 2.5F, -4.2037F);
			bone21.addChild(cube_r6);
			setRotationAngle(cube_r6, -0.6589F, 0.0F, 0.0F);
			cube_r6.cubeList.add(new ModelBox(cube_r6, -10, 16, -7.5F, -0.0361F, -9.9375F, 15, 0, 10, 0.0F, false));
