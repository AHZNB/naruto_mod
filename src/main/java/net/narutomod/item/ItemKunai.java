...
public class ItemKunai extends ElementsNarutomodMod.ModElement {
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("narutomod", "entitybulletkunai"), ENTITYID).name("entitybulletkunai").tracker(64, 1, true).build());
	}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, EntityLivingBase entityLivingBase, int timeLeft) {
			if (!world.isRemote && entityLivingBase instanceof EntityPlayerMP) {
				...
				for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
					...
					if (stack != null && stack.getItem() == new ItemStack(ItemKunai.block, (int) (1)).getItem()
							&& stack.getMetadata() == new ItemStack(ItemKunai.block, (int) (1)).getMetadata()) {
						slotID = i;
						break;
					}
				}
				if (entity.capabilities.isCreativeMode || EnchantmentHelper.getEnchantmentLevel(Enchantments.INFINITY, itemstack) > 0
					...
					entityarrow.shoot(entity.getLookVec().x, entity.getLookVec().y, entity.getLookVec().z, power * 2f, 0);
					...
					if (entity.capabilities.isCreativeMode) {
						...
						if (new ItemStack(ItemKunai.block, (int) (1)).isItemStackDamageable()) {
							...
							entity.inventory.clearMatchingItems(new ItemStack(ItemKunai.block, (int) (1)).getItem(), -1, 1, null);
						}
					}
					if (!world.isRemote)
