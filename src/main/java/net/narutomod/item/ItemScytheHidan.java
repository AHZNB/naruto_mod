...
public class ItemScytheHidan extends ElementsNarutomodMod.ModElement {
	...
	public static class RangedItem extends Item {
		public RangedItem() {
			...
			setMaxDamage(500);
			setFull3D();
			setUnlocalizedName("scythe_hidan");
			setRegistryName("scythe_hidan");
			maxStackSize = 1;
 ...
 SoundEvents.ENTITY_ARROW_SHOOT,
	...
	public static class EntityCustom extends EntityThrowable {
		private static final String SKEWERED_TIME = "HidanSkeweredTime";
	...
	/*public static class EntityCustom extends EntityArrow {
		...
		public static class KnockbackHook {
			@SubscribeEvent
			public void onKnockback(LivingKnockBackEvent event) {
				if (event.getEntity().getEntityData().getBoolean("TempData_damageFromThrownHidan")) {
					event.setCanceled(true);
					event.getEntity().getEntityData().removeTag("TempData_damageFromThrownHidan");
				}
			}
		}
	}
