...
public class ItemScytheMadara extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:scythe_madara")
	public static final Item block = null;
	public static final int ENTITYID = 405;
	private static final String USE_THROWN_MODEL = "UseThrownModel";

	public ItemScytheMadara(ElementsNarutomodMod instance) {
		super(instance, 795);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("narutomod", "entitybulletscythe_madara"), ENTITYID).name("entitybulletscythe_madara").tracker(64, 1, true)
				.build());
	}
	...
	public void registerModels(ModelRegistryEvent event) {
	    final ModelResourceLocation main_res = new ModelResourceLocation("narutomod:scythe_madara", "inventory");
	    final ModelResourceLocation thrown_res = new ModelResourceLocation("narutomod:scythe_madara_thrown", "inventory");

   	    ModelBakery.registerItemVariants(block, main_res, thrown_res);
	...
	public static class RangedItem extends Item implements ItemOnBody.Interface {
		public RangedItem() {
			...
			this.setFull3D();
			this.setUnlocalizedName("scythe_madara");
			this.setRegistryName("scythe_madara");
			this.maxStackSize = 1;
		...
		public void setEntity(ItemStack stack, EntityCustom entity) {
			...
			stack.getTagCompound().setInteger("KamaEntityId", entity.getEntityId());
		}

		@Nullable
		public EntityCustom getEntity(World world, ItemStack stack) {
			Entity entity = world.getEntityByID(stack.hasTagCompound() ? stack.getTagCompound().getInteger("KamaEntityId") : -1);
