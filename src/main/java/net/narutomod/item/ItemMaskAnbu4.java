...
public class ItemMaskAnbu4 extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:mask_anbu_4helmet")
	public static final Item helmet = null;

	public ItemMaskAnbu4(ElementsNarutomodMod instance) {
		super(instance, 812);
	}

	@Override
	public void initElements() {
		ItemArmor.ArmorMaterial enuma = EnumHelper.addArmorMaterial("MASK_ANBU_4", "narutomod:sasuke_", 25, new int[]{2, 5, 6, 2}, 0,
		...
		elements.items.add(() -> new ItemArmor(enuma, 0, EntityEquipmentSlot.HEAD) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
				return "narutomod:textures/mask_anbu4.png";
			}
		}.setUnlocalizedName("mask_anbu_4helmet").setRegistryName("mask_anbu_4helmet").setCreativeTab(TabModTab.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(helmet, 0, new ModelResourceLocation("narutomod:mask_anbu_4helmet", "inventory"));
	}
