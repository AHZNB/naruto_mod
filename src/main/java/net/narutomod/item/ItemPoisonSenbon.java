...
public class ItemPoisonSenbon extends ElementsNarutomodMod.ModElement {
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("narutomod", "entitybulletpoison_senbon"), ENTITYID).name("entitybulletpoison_senbon").tracker(64, 1, true)
				.build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityArrowCustom.class, renderManager -> {
			return new RenderSnowball(renderManager, new ItemStack(ItemSenbon.block, (int) (1)).getItem(), Minecraft.getMinecraft().getRenderItem());
		});
	}
