...
public class ItemScrollFireStream extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:scroll_fire_stream")
	public static final Item block = null;
	public ItemScrollFireStream(ElementsNarutomodMod instance) {
		super(instance, 691);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			entity.openGui(NarutomodMod.instance, GuiScrollFireStreamGui.GUIID, world, x, y, z);
			return ar;
		}
	}
}
