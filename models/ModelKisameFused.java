...
public static class ModelKisameFused extends ModelBase {
	...
	public ModelKisameFused() {
		...
		LeftArm.cubeList.add(new ModelBox(LeftArm, 40, 32, -1.0F, -2.0F, -2.0F, 4, 12, 4, 0.25F, true));

		LeftFin = new ModelRenderer(this);
		LeftFin.setRotationPoint(3.0F, 5.0F, 2.0F);
		LeftArm.addChild(LeftFin);
