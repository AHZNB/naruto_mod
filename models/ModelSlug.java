...
public static class ModelSlug extends ModelBase {
	...
	private final ModelRenderer Horn0_4;
	...
	private final ModelRenderer Horn0_8;
	...
	public ModelSlug() {
		...
		body.setRotationPoint(0.0F, 18.75F, 0.0F);
		setRotationAngle(body, 1.5708F, 0.0F, 0.0F);
		body.cubeList.add(new ModelBox(body, 92, 12, -2.0F, -6.0F, -5.0F, 4, 12, 0, 0.12F, false));
		...
		setRotationAngle(bodyFront, -0.3927F, 0.0F, -0.2618F);
		...
		setRotationAngle(head, -0.2618F, 0.0F, -0.2618F);
		...
		Horn0_4 = new ModelRenderer(this);
		Horn0_4.setRotationPoint(0.0F, -0.6499F, 0.0253F);
		Horn0_3.addChild(Horn0_4);
		setRotationAngle(Horn0_4, 0.0F, 0.0F, -0.0873F);
		Horn0_4.cubeList.add(new ModelBox(Horn0_4, 62, 0, 0.0F, -0.75F, -0.5F, 1, 1, 1, -0.05F, false));
		...
		Horn0_8 = new ModelRenderer(this);
		Horn0_8.setRotationPoint(0.0F, -0.6499F, 0.0253F);
		Horn0_7.addChild(Horn0_8);
		setRotationAngle(Horn0_8, 0.0F, 0.0F, 0.0873F);
		Horn0_8.cubeList.add(new ModelBox(Horn0_8, 62, 0, -1.0F, -0.75F, -0.5F, 1, 1, 1, -0.05F, true));
		...
		body.addChild(tail);
		setRotationAngle(tail, 0.0F, 0.0F, -0.3927F);
		...
		tailMid.setRotationPoint(0.0F, 5.75F, 0.0F);
		tail.addChild(tailMid);
		setRotationAngle(tailMid, 0.0F, 0.0F, -0.2618F);

		cube_r76 = new ModelRenderer(this);
		cube_r76.setRotationPoint(0.0F, 0.25F, 0.0F);
		tailMid.addChild(cube_r76);
		...
		tailEnd.setRotationPoint(0.0F, 6.0F, 0.5F);
		tailMid.addChild(tailEnd);
		setRotationAngle(tailEnd, 0.0F, 0.0F, -0.2618F);
		tailEnd.cubeList.add(new ModelBox(tailEnd, 1, 8, -0.5F, 5.65F, -1.0F, 1, 0, 1, 0.0F, false));

		cube_r92 = new ModelRenderer(this);
		cube_r92.setRotationPoint(0.0F, -0.25F, -0.5F);
		tailEnd.addChild(cube_r92);
