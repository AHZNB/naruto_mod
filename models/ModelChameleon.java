...
public static class ModelChameleon extends ModelBase {
	...
	public ModelChameleon() {
		...
		tail.setRotationPoint(0.0F, -0.2F, 13.75F);
		body.addChild(tail);
		setRotationAngle(tail, 0.2618F, 0.0F, 0.0F);
		tail.cubeList.add(new ModelBox(tail, 24, 9, -2.55F, -2.05F, -1.3F, 5, 4, 6, -0.2F, false));

		bone65 = new ModelRenderer(this);
		bone65.setRotationPoint(-0.05F, 0.0F, 4.5F);
		tail.addChild(bone65);
		setRotationAngle(bone65, 0.3491F, 0.2618F, 0.2618F);
		bone65.cubeList.add(new ModelBox(bone65, 24, 9, -2.5F, -2.0F, -1.0F, 5, 4, 6, -0.4F, false));

		bone66 = new ModelRenderer(this);
		bone66.setRotationPoint(0.0F, 0.05F, 4.5F);
		bone65.addChild(bone66);
		setRotationAngle(bone66, 0.5236F, 0.5236F, 0.5236F);
		bone66.cubeList.add(new ModelBox(bone66, 24, 9, -2.5F, -2.0F, -1.25F, 5, 4, 6, -0.7F, false));

		bone67 = new ModelRenderer(this);
		bone67.setRotationPoint(0.05F, -0.1F, 3.95F);
		bone66.addChild(bone67);
		setRotationAngle(bone67, 0.5236F, 0.5236F, 0.2618F);
		bone67.cubeList.add(new ModelBox(bone67, 24, 9, -2.5F, -2.0F, -1.5F, 5, 4, 6, -0.9F, false));

		bone68 = new ModelRenderer(this);
		bone68.setRotationPoint(-0.05F, 0.05F, 3.5F);
		bone67.addChild(bone68);
		setRotationAngle(bone68, 0.5236F, 0.4363F, -0.2618F);
		bone68.cubeList.add(new ModelBox(bone68, 24, 9, -2.5F, -2.0F, -1.5F, 5, 4, 6, -1.0F, false));

		bone69 = new ModelRenderer(this);
		bone69.setRotationPoint(0.0F, 0.0F, 3.3F);
		bone68.addChild(bone69);
		setRotationAngle(bone69, 0.2618F, 0.3491F, -0.2618F);
		bone69.cubeList.add(new ModelBox(bone69, 24, 9, -2.5F, -2.0F, -1.5F, 5, 4, 6, -1.1F, false));

		bone71 = new ModelRenderer(this);
		bone71.setRotationPoint(0.0F, 0.0F, 3.0F);
		bone69.addChild(bone71);
		setRotationAngle(bone71, 0.1745F, 0.2618F, -0.2618F);
		bone71.cubeList.add(new ModelBox(bone71, 24, 9, -2.5F, -2.0F, -1.5F, 5, 4, 6, -1.2F, false));

		bone72 = new ModelRenderer(this);
		bone72.setRotationPoint(0.0F, 0.0F, 3.0F);
		bone71.addChild(bone72);
		setRotationAngle(bone72, 0.0873F, 0.0873F, -0.2618F);
		bone72.cubeList.add(new ModelBox(bone72, 24, 9, -2.51F, -1.96F, -1.54F, 5, 4, 6, -1.3F, false));

		snakeHead = new ModelRenderer(this);
		snakeHead.setRotationPoint(-0.0653F, 0.2638F, 2.8455F);
		bone72.addChild(snakeHead);
		setRotationAngle(snakeHead, 0.0F, 3.1416F, 0.0F);

		bone = new ModelRenderer(this);
		bone.setRotationPoint(-0.5792F, -0.5468F, -0.9687F);
		snakeHead.addChild(bone);
		setRotationAngle(bone, 0.1309F, -0.0873F, 0.0F);
		bone.cubeList.add(new ModelBox(bone, 0, 44, -2.0F, -0.5F, -2.0F, 4, 1, 4, -1.15F, false));

		bone39 = new ModelRenderer(this);
		bone39.setRotationPoint(0.0F, -0.65F, -0.65F);
		bone.addChild(bone39);
		setRotationAngle(bone39, 0.1745F, -0.1745F, 0.0436F);
		bone39.cubeList.add(new ModelBox(bone39, 4, 55, -2.0F, 0.15F, -2.9F, 4, 1, 4, -1.15F, false));

		bone62 = new ModelRenderer(this);
		bone62.setRotationPoint(0.5597F, -0.5468F, -0.9687F);
		snakeHead.addChild(bone62);
		setRotationAngle(bone62, 0.1309F, 0.0873F, 0.0F);
		bone62.cubeList.add(new ModelBox(bone62, 0, 44, -2.0F, -0.5F, -2.0F, 4, 1, 4, -1.15F, true));

		bone63 = new ModelRenderer(this);
		bone63.setRotationPoint(0.0F, -0.65F, -0.65F);
		bone62.addChild(bone63);
		setRotationAngle(bone63, 0.1745F, 0.1745F, -0.0436F);
		bone63.cubeList.add(new ModelBox(bone63, 4, 55, -2.0F, 0.15F, -2.9F, 4, 1, 4, -1.15F, true));

		snakeJaw = new ModelRenderer(this);
		snakeJaw.setRotationPoint(-0.0229F, -0.0006F, 0.0045F);
